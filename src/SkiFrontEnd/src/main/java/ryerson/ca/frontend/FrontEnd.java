    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (hiddenParam) {
            case "login":
                ...
                if (Business.isAuthenticated(username, passwrod) && token.isEmpty()) {
              ...
              SkiXML result;
                 result = retreiveServicesFromBackend(username, null);
                    request.setAttribute("skiResults", result);
                    RequestDispatcher requestDispatcher = request.getRequestDispatcher("CartWithLogin.jsp");
